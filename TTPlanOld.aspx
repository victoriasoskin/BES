<%@ Page Title="" Language="VB" MasterPageFile="~/Empty.master" AutoEventWireup="false" CodeFile="TTPlanOld.aspx.vb" Inherits="TTPlanOld" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" validateRequest="false" %>
...
<div id="divwordmsg" style="margin-bottom:20px;border:4px outset Gray;text-align:center;background-color:#EEEEEE;position:fixed;top:150px;right:250px;display:none;">
	<br />&nbsp;&nbsp;&nbsp;&nbsp;סמן את החלקים שהינך מעוניין להעביר למסמך WORD&nbsp;&nbsp;&nbsp;&nbsp;
		<div style="text-align:right;">
				<asp:CheckBoxList runat="server" ID="cblWord" ForeColor="#3582B9" >
					<asp:ListItem Value="1" Selected="True">מידע כללי על הלקוח</asp:ListItem>
...
--%>			</td>
	...
	<asp:AlwaysVisibleControlExtender runat="server" TargetControlID="divbuttons" HorizontalOffset="740" VerticalOffset="65" HorizontalSide="Right">
	...
	<hr />
	<div id="divFormQ" style="display:none;">
				...
				<tr>
					<td>
						<table style="width:100%" dir="rtl">
							...
							<tr style="width:5%">
								<td rowspan="2">
									<asp:Button runat="server" ID="btnEdit" CommandName="Edit" Text="עריכה" Visible="false"/>
								</td>
		...
		<hr />
		<asp:UpdatePanel runat="server" ID="UPDp"><ContentTemplate>
...
<%--						<asp:Button runat="server" ID="btnEdit" CommandName="edit" Text="עריכה" CausesValidation="false" Visible='<%#IsEditable() %>'  />
		...
		<div style="width:100%;text-align:left;"><asp:Button runat="server" ID="btnprWP" Text="הדפס" CausesValidation="false" /></div>
	</div>
			...
			<ItemTemplate>
				<tr>
					<td class="tdxprint" style="white-space:normal;background-color:White;min-height:40px;vertical-align:top;">
						<asp:linkbutton runat="server" ID="hl1" Text='<%#WW(1) %>' OnClientClick='<%# OpenPopUP("א") %>' Width="100%" CausesValidation="false" CssClass="btn" />
					</td>
					<td class="tdxprint"  style="white-space:normal;background-color:White;min-height:40px;vertical-align:top;">
						<asp:linkbutton runat="server" ID="hl2" Text='<%#WW(2) %>' OnClientClick='<%# OpenPopUP("ב") %>' Width="100%" CausesValidation="false" CssClass="btn" />
					</td>
					<td class="tdxprint"  style="white-space:normal;background-color:White;min-height:40px;vertical-align:top;">
						<asp:linkbutton runat="server" ID="hl3" Text='<%#WW(3) %>' OnClientClick='<%# OpenPopUP("ג") %>' Width="100%" CausesValidation="false" CssClass="btn" />
					</td>
					<td class="tdxprint"  style="white-space:normal;background-color:White;min-height:40px;vertical-align:top;">
						<asp:linkbutton runat="server" ID="hl4" Text='<%#WW(4) %>' OnClientClick='<%# OpenPopUP("ד") %>' Width="100%" CausesValidation="false" CssClass="btn" />
					</td>
					<td class="tdxprint"  style="white-space:normal;background-color:White;min-height:40px;vertical-align:top;">
						<asp:linkbutton runat="server" ID="hl5" Text='<%#WW(5) %>' OnClientClick='<%# OpenPopUP("ה") %>' Width="100%" CausesValidation="false" CssClass="btn" />
						</td>
					<td class="tdxprint"  style="white-space:normal;background-color:White;min-height:40px;vertical-align:top;">
						<asp:linkbutton runat="server" ID="hl6" Text='<%#WW(6) %>' OnClientClick='<%# OpenPopUP("ו") %>' Width="100%" CausesValidation="false" CssClass="btn" />
					</td>
					<td class="tdxprint"  style="white-space:normal;background-color:White;min-height:40px;vertical-align:top;">
						<asp:linkbutton runat="server" ID="hl7" Text='<%#WW(7) %>' OnClientClick='<%# OpenPopUP("ש") %>' Width="100%" CausesValidation="false" CssClass="btn" />
					</td>
				</tr>
			</ItemTemplate>
		</asp:ListView>
</div>
		<div style="width:100%;text-align:left;"><asp:Button runat="server" ID="btnprWWP" Text="הדפס" style="float:left;" CausesValidation="false" /></div>
<hr />
<div style="width:100%;">
...
INSERT INTO TT_WorkPlan(WpID, FormID, Purpose, Description, Criteria, CustEventID, LoadTime, UserID) VALUES (@WpID,@FormID, @Purpose, @Description, @Criteria, @CustEventID, GETDATE(), @UserID)" >
	...
	<asp:SqlDataSource ID="DSAnswerSets" runat="server" 
		ConnectionString="<%$ ConnectionStrings:Book10VPSC %>" SelectCommand="SELECT Val,Txt FROM TT_AnswerSets WHERE AnswersetID=1 ORDER BY Val DESC" >
	</asp:SqlDataSource>
</div>
