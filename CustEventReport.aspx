<%@ Page Language="VB" MasterPageFile="~/Sherut.master" AutoEventWireup="false" CodeFile="CustEventReport.aspx.vb" Inherits="CustEventReport" title="בית אקשטיין - ניהול תיקי לקוחות" %>
...
function PostBackOnMainPage(){
  ...
  <div runat="server" id="divmsg" visible="false">
    ...
    <table>
        ...
        Text="ניהול תיקי לקוחות" Width="432px"></asp:Label></td>
            <td style="width: 86px">
                ...
                <tr>
                    ...
                    <td style="width: 100px; height: 160px" valign="top" align="center">
                        <asp:Calendar ID="CalEvent" runat="server" BackColor="White" BorderColor="#3366CC" 
                            ...
                            Width="220px" CellPadding="1" VisibleDate="2008-03-11" OnSelectionChanged="CalEvent_SelectionChanged" OnLoad="CalEvent_Load" ToolTip="ניתן לבחור תאריך בתאריכון או להקליד תאריך בתיבת הטקסט מתחתיו">
                    ...
                    <td align="center" style="width: 100px; height: 160px" valign="top">
                        ...
                        <asp:Button ID="BtnOK" runat="server" Style="position: static"
                            Text="הוספת הפעולה" OnClick="BtnOK_Click" onprerender="BtnOK_PreRender" /></td>
                </tr>
                <tr>
                        ...
                        <asp:TemplateField HeaderText="שינויים">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="LBTNDEL" runat="server" CausesValidation="False" 
                                    ...
                                    Visible='<%# Eval("AllowC") AND Eval("CustEventUrl") & vbnullstring = vbnullstring %>' onclick="LBTNDEL_Click">מחיקה</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
