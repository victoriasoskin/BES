...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="position: absolute; top: 108px; right: 0px; padding-right: 5px; width: 950px;">
        ...
        -------------------------- ---%>
            ...
            <InsertItemTemplate>
                <tr>
                    <td colspan="5" class="phdr">תמיכה חדשה
                        ...
                        <asp:ListView runat="server" ID="dlDetails" OnPreRender="dlDetails_PreRender" InsertItemPosition="FirstItem" OnItemInserting="Det_Inserting" OnItemEditing="lv_ItemEditing" OnItemUpdating="Det_Updating">
                            ...
                            <InsertItemTemplate>
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="white-space: nowrap;">
                                        <asp:LinkButton runat="server" ID="lnkbSave" Text="שמירה" CssClass="btns" CommandName="insert"></asp:LinkButton>
                            ...
                            <EditItemTemplate>
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="white-space: nowrap;">
                                        <asp:LinkButton runat="server" ID="lnkbSave" Text="שמירה" CssClass="btns" CommandName="update"></asp:LinkButton>
            ...
            <EditItemTemplate>
                <tr>
                    <td colspan="5" class="pEhdr">עריכת תמיכה מספר <%#Eval("Ln") %>
                      <asp:LinkButton runat="server" ID="lnkbSaveClose" Text="שמירה וסגירה" CommandName="Cancel" CssClass="btns"></asp:LinkButton>
                        <asp:LinkButton runat="server" ID="lnkbSave" Text="שמירה" CssClass="btns"></asp:LinkButton>
                        <asp:LinkButton runat="server" ID="lnkbCancel" Text="ביטול" CssClass="btns" CommandName="cancel" CausesValidation="false"></asp:LinkButton></td>
                </tr>
                <asp:HiddenField runat="server" ID="hdnWPId" Value='<%#Eval("Id") %>' />
                </td>
                </tr>
                    ...
                    <td>
                        ...
                        <%-- <InsertItemTemplate>
                                ...
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbDetails" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" />
                                    ...
                                    <td rowspan="3">
                                        ...
                                        <br />
                                        <asp:TextBox runat="server" ID="tbHelper" Width="85" MaxLength="40" Style="display: none;" TextMode="MultiLine" OnPreRender="tbOther_PreRender" />
                                        <br />
                                ...
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbText1" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" />
                                ...
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbText2" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" />
                        ...
                        <%--<EditItemTemplate>
                                <tr style="vertical-align: top;">
                                    ...
                                    <td style="">
                                        <asp:HiddenField runat="server" ID="hdnId" Value='<%#Eval("Id") %>' />
                                        <asp:TextBox runat="server" ID="tbDetails" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" Text='<%#Eval("Text") %>' />
                                    </td>
                                    <td rowspan="3">
                                    ...
                                    <td rowspan="3">
                                        ...
                                        <asp:TextBox runat="server" ID="tbHelper" Width="85" MaxLength="40" Style="display: none;" TextMode="MultiLine" OnPreRender="tbOther_PreRender" />
                                        <br />
                                        <asp:TextBox runat="server" ID="tbSupporterName" Width="85" MaxLength="40" TextMode="MultiLine" Text='<%#Eval("SupporterName") %>' />
                                ...
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbText1" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" Text='<%#Eval("Text1") %>' />
                                    </td>
                                </tr>
                                <tr style="vertical-align: top;" class="editbck">
                                    <td>מדדים
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbText2" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" Text='<%#Eval("Text2") %>' />
                                    </td>
                                </tr>
                        ...
                        <asp:ListView runat="server" ID="dlDetails" OnPreRender="dlDetails_PreRender" InsertItemPosition="LastItem" DataKeyNames="Id" OnItemEditing="lv_ItemEditing" OnItemCanceling="lv_ItemCanceling" OnItemUpdating="Det_Updating">
                            ...
                            <ItemTemplate>
                                <tr style="vertical-align: top;">
                                    ...
                                    <td>
                                        <asp:Literal runat="server" ID="litDetails_Edit" OnPreRender="lit_Prerender" Text="עריכה" />
                                        <asp:LinkButton runat="server" ID="lnkbDelete" Text="מחיקה" CssClass="btns" OnClientClick="return confirm('האם למחוק?');" OnClick="lnkbDelete_Click"></asp:LinkButton></td>
                                </tr>
                            </ItemTemplate>
                            ...
                            <InsertItemTemplate>
                                <tr style="vertical-align: top;">
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox runat="server" ID="tbHelper" Width="85" MaxLength="40" Style="display: none;" TextMode="MultiLine" OnPreRender="tbOther_PreRender" /></td>
                                    <td style="white-space: nowrap;">
                                        <asp:LinkButton runat="server" ID="lnkbSave" Text="שמירה" CssClass="btns" OnClick=" InsertDetails"></asp:LinkButton>
                                        <asp:LinkButton runat="server" ID="lnkbCancel" Text="ביטול" CssClass="btns" OnClick="lnkbCancel_Click" CausesValidation="false"></asp:LinkButton></td>
                                </tr>
                            </InsertItemTemplate>
                            ...
                            <EditItemTemplate>
                                <tr style="vertical-align: top;">
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox runat="server" ID="tbHelper" Width="85" MaxLength="40" Style="display: none;" TextMode="MultiLine" OnPreRender="tbOther_PreRender" /></td>
                                    <td style="white-space: nowrap;">
                                        <asp:LinkButton runat="server" ID="lnkbSave" Text="שמירה" CssClass="btns" CommandName="update">

                                        </asp:LinkButton><asp:LinkButton runat="server" ID="lnkbCancel" Text="ביטול" CommandName="cancel" CssClass="btns" OnClick="lnkbCancel_Click" CausesValidation="false"></asp:LinkButton></td>
                                </tr>
                            </EditItemTemplate>
                        </asp:ListView>
    ...
    <div id="divWeeklytimetable" runat="server" class="wkhide">
