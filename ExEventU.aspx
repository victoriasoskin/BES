<%@ Page Language="VB" MasterPageFile="~/Sherut.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="ExEventU.aspx.vb" Inherits="ExEvent" title="בית אקשטיין - טופס ארוע חריג" %>
...
<asp:SqlDataSource ID="DSEXEvents" runat="server" ConnectionString="<%$ ConnectionStrings:bebook10 %>"
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Black"
        Text="דיווח על ארוע חריג                    טופס מס' 1" Width="147px"></asp:Label>
    <br />
    <div runat="server" id="divrstr" visible="false">
        <asp:Label runat="server" ID="lblx" Text="שחזור אוטומטי של ארוע חריג שהזנתו הסתיימה ללא שמירה בבסיס הנתונים, האם לבטל?" ForeColor="Red" />
        <asp:RadioButtonList runat="server" ID="rblrst" ForeColor="Red" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblrst_SelectedIndexChanged" AutoPostBack="true" >
            <asp:ListItem Value="0" Text="לא" Selected="True" />
            <asp:ListItem Value="1" Text="כן" />
        </asp:RadioButtonList>
    </div>
    <asp:UpdatePanel runat="server" ID="updx" ><ContentTemplate>
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="ExEventID" DataSourceID="DSEXEvents" DefaultMode="Insert">
        <InsertItemTemplate>
            <table border="1">
                <tr>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td bgcolor="#99ccff" style="width: 340px; color: #FF0000;">
                               ס<span style="color: #FF0000">יווג הארוע</span></td>
                            <td style="width: 100px">
                        ...
                        <table border="1">
                            ...
                            <tr>
                                <td bgcolor="#99ccff" style="width: 340px">
                                    שם הדוח</td>
                                <td style="width: 100px">
                                    <asp:Label ID="LBLHDR" runat="server" Text='<%# Eval("ExEventHeader") %>' 
                                        Width="400px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <asp:Label ID="LBLEXDATE" runat="server" 
                                        Text='<%# Bind("CustEventDate", "{0:g}") %>' Width="400px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 340px">
                            ...
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <asp:Label ID="LBLLOCDESC" runat="server" 
                                        Text='<%# Eval("ExEventLocationDescrption") %>' Width="400px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 100px">
                                    איש הצוות הראשון לדעת על הארוע (שם ותפקיד)</td>
                                <td style="width: 100px">
                                    <asp:Label ID="LBLFIRST" runat="server" Text='<%# Eval("ExEventReporterJob") %>' 
                                        Width="400px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 100px">
                                    נזקי גוף</td>
                                <td style="width: 100px">
                                    <asp:Label ID="LBLBODYINJURY" runat="server" Text='<%# Eval("ExEventBodyInjury") %>' 
                                        Width="400px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 100px">
                                    נזקי רכוש</td>
                                <td style="width: 100px">
                                    <asp:Label ID="LBLPROPERTYDAMAGE" runat="server" 
                                        Text='<%# Eval("ExEventpropertyDamages") %>' Width="400px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 100px">
                                ...
                                <td style="width: 100px">
                                    <asp:Label ID="LBLSTORY" runat="server" Text='<%# Eval("ExEventStory") %>' 
                                        Width="400px"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="1">
                            ...
                            <tr>
                                ...
                                <td style="width: 103px; height: 40px;">
                                    <asp:Label ID="LBLIMMEDIAT" runat="server" 
                                        Text='<%# Eval("ExEventimmediateActions") %>' Width="400px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 100px">
                                ...
                                <td style="width: 103px">
                                    <asp:Label ID="LBLREQUIRED" runat="server" 
                                        Text='<%# Eval("ExEventRequiredActions") %>' Width="400px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 100px">
                                ...
                                <td style="width: 103px">                                   
                                    <table style="width: 100%">
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label24" runat="server" Text='<%# Eval("ShortSatatus") %>' 
                                                    Visible='<%# Eval("ExEventStatusID")=3 %>' Width="100px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label25" runat="server" 
                                                    Text='<%# Eval("ExEventAsClosingDate", "{0:g}") %>' 
                                                    Visible='<%# Eval("ExEventStatusID")=3 or bPrint %>' Width="217px"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <asp:HiddenField runat="server" ID="HDNCLOSINGDate" />
</td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 100px">
                                    <asp:Label ID="LBx" runat="server" Text="מדוע הארוע לא נסגר?" Visible="False"
                                        Width="120px"></asp:Label></td>
                                <td style="width: 103px">
                                    <asp:TextBox ID="TBWNC" runat="server" Text='<%# Bind("ExEventWhyNotClosed") %>'
                                        TextMode="MultiLine" Visible='<%# Eval("ExEventStatusID")=2 %>' Width="400px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td bgcolor="#99ccff" style="width: 100px">
                            ...
                            <tr>
                                <td style="width: 100px">
                                    <asp:LinkButton ID="LNKBINSERT" runat="server" OnClick="LNKBINSERT_Click" 
                                        ToolTip="לחץ לכתיבת הארוע לבסיס הנתונים" 
                                        Visible='<%# Eval("ExEventStatusID")<>3 and not bprint %>'>שליחה למערכת</asp:LinkButton></td>
                                <td style="width: 103px">
