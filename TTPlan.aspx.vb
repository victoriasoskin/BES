...
#Region "Load"
    ...
    Function OpenNewPlan(iFormTypeID As Integer, iFrameID As Integer, lCustomerID As Long) As Integer
        ...
        If iC <> 0 Then
            Response.Redirect(String.Format("TTPlan.aspx?FT={0}&ID={1}", iFormTypeID, iC))
        End If
    ...
    Protected Sub hdn_PreRender(sender As Object, e As System.EventArgs)
        ...
        PageHeader1.Header = hdn.Value.Replace("תוכנית", "רקע לניהול")
    End Sub
...
#Region "Util"
    ...
    Function GetCurrentVersion() As Integer
        ...
        Dim cD21 As New SqlCommand("EXEC TT_pVersionControl " & Session("LastCustID") & "," & Session("FrameID") & "," & Session("UserID") & "," & "'רקע לניהול תמיכות'" & "," & Request.QueryString("CTID"), dbConnection21)
...
#End Region
    ...
    Protected Sub btnOldWP_Click(sender As Object, e As EventArgs)
        Dim s As String = Request.RawUrl()
        Response.Redirect(s.Replace("TTPlan", "TTPlanOld"))
    End Sub
End Class
