<%@ Page Title="" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="Test5.aspx.cs" Inherits="WebPWI1.Test5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <ContentTemplate>
            <div runat="server" id="divFrame">
                ...
                <table id="tblfaces" runat="server">
                    <tr>
                        <td>
                            <asp:ImageButton ID="VeryHappyA1" runat="server" OnClick="Face_Click" Height="160px" ImageUrl="PWI/Faces/veryhappy.jpg" Width="160px" BorderWidth="10" OnPreRender="ibtn_PreRender" BorderColor="Black" BorderStyle="Solid" />
                        </td>
                        <td>
                            <asp:ImageButton ID="HappyA1" runat="server" OnClick="Face_Click" Height="160px" ImageUrl="PWI/Faces/happy.jpg" Width="160px" BorderWidth="10" OnPreRender="ibtn_PreRender" BorderColor="Black" />
                        </td>
                        <td>
                            <asp:ImageButton ID="NonoA1" runat="server" OnClick="Face_Click" Height="160px" ImageUrl="PWI/Faces/nono.jpg" Width="160px" BorderWidth="10" OnPreRender="ibtn_PreRender" BorderColor="Black" />
                        </td>
                        <td>
                            <asp:ImageButton ID="SadA1" runat="server" OnClick="Face_Click" Height="160px" ImageUrl="PWI/Faces/sad.jpg" Width="160px" BorderWidth="10" OnPreRender="ibtn_PreRender" BorderColor="Black" />
                        </td>
                        <td>
                            <asp:ImageButton ID="VerySadA1" runat="server" OnClick="Face_Click" Height="160px" ImageUrl="PWI/Faces/verysad.jpg" Width="160px" BorderWidth="10" OnPreRender="ibtn_PreRender" BorderColor="Black" />
                        </td>
                    </tr>
                </table>
  ...
  <asp:ImageButton ID="Hint" runat="server"  Height="100px" ImageUrl="hint.png"      Width="100px" style="float:left;"  /> 
     ...
     <p>
     <div class="wrapper">
          <asp:ImageButton ID="VerySadA1" runat="server"  onclick="Face_Click" Height="100px"   ImageUrl="PWI/Faces/verysad.jpg"      Width="100px" CssClass=faceButton  OnPreRender="ibtn_PreRender"/>
        <asp:ImageButton ID="SadA1" runat="server" onclick="Face_Click" Height="100px"          ImageUrl="PWI/Faces/sad.jpg" Width="100px" CssClass=""/>
        ...
        <asp:ImageButton ID="VeryHappyA1" runat="server" onclick="Face_Click" Height="100px"    ImageUrl="PWI/Faces/veryhappy.jpg" Width="100px" CssClass=faceButton OnPreRender="ibtn_PreRender"/>
          <br />
        <asp:Label ID="Feedback" runat="server" Text="" Font-Bold=true ForeColor=Red></asp:Label>
 </div>
           <div class="next">
