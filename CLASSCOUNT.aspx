<%@ Page Language="VB" MasterPageFile="~/Sherut.master" AutoEventWireup="false" CodeFile="CLASSCOUNT.aspx.vb" Inherits="Default5" title="בית אקשטיין - יעד לקוחות" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td colspan="2">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Blue"
                    Text="עמידה ביעד כיתות" Width="368px"></asp:Label></td>
        ...
        <tr>
            ...
            <td align="right"> 
                <asp:DropDownList ID="DDLWY" runat="server" DataSourceID="DSWY" 
                    DataTextField="Yr" DataValueField="FirstDate" AutoPostBack="True" 
        ...
        <tr>
            ...
            <asp:TemplateField HeaderText="מסגרת">
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLFRAME" runat="server" Text='<%# Bind("Frame")%>' OnPreRender="LBLFRAME_PreRender"></asp:Label>
                </ItemTemplate>
                <FooterTemplate>
                    סה"כ
                </FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="סוג">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="LBLTYPE" runat="server" Text='<%# Bind("Typ") %>'></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                                <table>
                                    <tr>
...
<%--                    <asp:label runat="server" id="LBLD1" Text='<%# hdrt(1) %>'/>             --%>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS1" runat="server" Width="30px" Text='<%# vald(1,Eval("typ")) %>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS2" runat="server" Width="30px" Text='<%# vald(2,Eval("Typ")) %>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS3" runat="server" Width="30px" Text='<%# vald(3,Eval("Typ")) %>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
             ...
             <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS4" runat="server" Width="30px" Text='<%# vald(4,Eval("Typ")) %>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
              ...
              <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS5" runat="server" Width="30px" Text='<%# vald(5, Eval("Typ"))%>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
             ...
             <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS6" runat="server" Width="30px" Text='<%# vald(6, Eval("Typ"))%>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
             ...
             <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS7" runat="server" Width="30px" Text='<%# vald(7, Eval("Typ"))%>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS8" runat="server" Width="30px" Text='<%# vald(8, Eval("Typ"))%>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                 <FooterTemplate>                    
             ...
             <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS9" runat="server" Width="30px" Text='<%# vald(9, Eval("Typ"))%>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
             ...
             <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS10" runat="server" Width="30px" Text='<%# vald(10, Eval("Typ"))%>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS11" runat="server" Width="30px" Text='<%# vald(11, Eval("Typ"))%>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                 <FooterTemplate>                    
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="LBLS12" runat="server" Width="30px" Text='<%# vald(12, Eval("Typ"))%>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
                <FooterTemplate>                    
    ...
    <asp:SqlDataSource ID="DSWY" runat="server" ConnectionString="<%$ ConnectionStrings:bebook10 %>"
        SelectCommand="SELECT Yr,FirstDate FROM Book10.dbo.Versions WHERE DATEPART(MONTH,FirstDate) = 9
">
     </asp:SqlDataSource>
    <asp:SqlDataSource ID="DSSvA" runat="server" ConnectionString="<%$ ConnectionStrings:bebook10 %>"
        SelectCommand="Book10.dbo.In_pClassCount" SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False">
        <SelectParameters>
            <asp:ControlParameter ControlID="DDLWY" Name="Y" PropertyName="SelectedItem.Text"
                Type="String" />
