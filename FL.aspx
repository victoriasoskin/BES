<%@ Page Title="" Language="VB" MasterPageFile="~/Sherut.master" AutoEventWireup="false" CodeFile="FL.aspx.vb" Inherits="FL" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        <tr>
            <td>
                מסגרות בארועים חריגים</td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            <td> 
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="rowid" DataSourceID="AccessDataSource1" 
