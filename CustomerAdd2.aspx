<%@ Page Language="VB" MasterPageFile="~/Sherut.master"  AutoEventWireup="false" CodeFile="CustomerAdd2.aspx.vb" Inherits="CustomerAdd2" title="בית אקשטיין - הוספת לקוח" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td style="width: 100px">
                <asp:Label ID="LBLHDR" runat="server" Font-Size="Large" Text="הוספת לקוח" 
                       ...
                       <table>
                           <tr>
                               <td bgcolor="#37a5ff" colspan="4" style="text-align: center" >
                                   <asp:label id="LBLHD1" runat="server" font-size="12pt" Text="פרטי הלקוח" /></td>
                            ...
                            <tr>
                                <td bgcolor="#37a5ff" >
                                    <asp:Label ID="Label3" runat="server" Text="ת.ז. / דרכון"  ForeColor="Red" Width="68px"></asp:Label></td>
                                <td>
                                    <asp:TextBox ID="TBID" runat="server" Text='<%# Bind("CustomerID") %>' Width="80px" OnTextChanged="TBID_TextChanged" TabIndex="10" ToolTip="הקלד את תעודת הזהות"></asp:TextBox><asp:Button
                                        ID="BTNEXIST" runat="server" CausesValidation="False" Text="האם קיים?" ValidationGroup="a" /></td>
                                <td style="width: 290px">
                                    <asp:RequiredFieldValidator ID="RFVID" runat="server" ControlToValidate="TBID"
                                        ...
                                        ErrorMessage="מס ת.ז. זה כבר קיים במערכת" Width="287px"></asp:CustomValidator></td>
                                <td style="width: 100px">
                                    &nbsp;
                                </td>
                                <td bgcolor="#37a5ff" colspan="2">
                                    <asp:Button ID="BTNCOPYCUSTTOAPT" runat="server" CausesValidation="False" OnClick="BTNCOPYCUSTTOAPT_Click"
                                        Text="העתקת כתובת הלקוח לכתובת האפוטרופוס" Width="250px" ToolTip='לחיצה על הכפתור מעתיקה מפרטי הלקוח/מועמד לפרטי האפוטרופוס את השדות הבאים: כתובת, עיר, מיקוד, טלפון, טלפון סלולרי,  ודוא"ל.' />
                                    </td>
                                <td bgcolor="#37a5ff" colspan="2">
                            ...
                            <tr>
                                ...
                                <td bgcolor="#37a5ff" rowspan="2" style="width: 112px">
                                    <strong>כתובת האפוטרופוס</strong></td>
                            ...
                            <tr>
                                ...
                                <td style="width: 197px; border-top: gray thin dotted; border-left: gray thin dotted; height: 26px;" bordercolordark="#000099">
									...
									<asp:RequiredFieldValidator runat="server" ID="rfvgm" ControlToValidate="DDLORIGINOFFICE" Display="Dynamic" ErrorMessage="חובה לבחור גורם מפנה" />
                                </td>
                           ...
                           <tr>
                               ...
                               <td style="width: 197px; ">
                                   <asp:DropDownList ID="DDLMEDCARE" runat="server" AppendDataBoundItems="True" DataSourceID="DSMEDCARE" DataTextField="CustMedCareName" DataValueField="CustMedCareID" TabIndex="66" SelectedValue='<%# Bind("CustMedCareID") %>'>
                                       <asp:ListItem Value="">&lt;בחר מבטח רפואי&gt;</asp:ListItem>
                                   </asp:DropDownList></td>
                               <td style="width: 290px; ">
                               </td>
                               <td style="width: 100px; ">
                            ...
                            <tr>
                                <td bgcolor="#37a5ff" rowspan="2" style="width: 113px">
                                    <asp:Label ID="LBLADDRESSHDR" runat="server" Font-Bold="true" >כתובת הלקוח</asp:Label></td>
                           ...
                           <tr>
                               ...
                               <td style="height: 25px">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9"  Enabled='<%# int(Session("ServiceID"))<>5 %>' runat="server" ControlToValidate="TBCUSTCITY"
                                        Display="Dynamic" ErrorMessage="חובה לבחור עיר" Width="93px"></asp:RequiredFieldValidator></td>
                        ...
                        <asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert"
                            Text="הוספה" TabIndex="500"></asp:LinkButton>&nbsp;&nbsp; &nbsp;
                        <asp:LinkButton ID="InsertCancelButton" runat="server" CausesValidation="False" CommandName="cancel"
                            Text="עבור לרשימת לקוחות" PostBackUrl="~/CustomerList.aspx" TabIndex="510"></asp:LinkButton>
                        &nbsp;&nbsp; &nbsp;<asp:LinkButton ID="LnkBADDNGO" runat="server" CommandName="Insert" Text="הוספה ומעבר לניהול תיקי לקוחות" TabIndex="520" OnClick="LinkButton1_Click" ToolTip="לחיצה תוסיף את הלקוח/מועמד לבסיס הנתונים ותעבור לניהול תיקי לקוחות/מועמדים תוך כדי סימון הלקוח/מועמד שנוסף"></asp:LinkButton>
                    </InsertItemTemplate>
                </asp:FormView>
                &nbsp;
            </td>
