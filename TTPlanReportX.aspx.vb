...
Partial Class TTPlanReportX
    ...
    Sub dbg(s As String, Optional bError As Boolean = True)
        ...
        'Response.End()
    End Sub
    Protected Sub DSWorkPlanReport_DB(sender As Object, e As System.Web.UI.WebControls.SqlDataSourceCommandEventArgs) Handles DSWorkPlanReport.Selecting
    ...
    Function FindPlanCustEventID() As Integer
        ...
        If Not IsNumeric(s) Then
            ...
            Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connStr)
            Dim cD As New SqlCommand("SELECT CustEventID FROM CustEventList WHERE CustEventTypeID=128 AND CustEventID IN (SELECT CustEventID FROM CustStatus WHERE CustomerID=" & Request.QueryString("C") & ")", dbConnection)
            dbConnection.Open()
