...
Class NTreeDropDown
    ...
    Sub PShowTree()
        ...
        If zzztvDropDown.Visible = True And zzztvDropDown.Nodes.Count > 0 Then
            ...
            If ShowCheckBoxes Then
                ...
                Dim cC As TreeNodeCollection = zzztvDropDown.CheckedNodes
                Dim cIt As TreeNode = Nothing
                For i As Integer = 0 To cC.Count - 1
                    ...
                    End If
                Next
                SelectedValue = If(sX IsNot Nothing, sX.Substring(0, sX.Length - 1), vbNullString)
                SelectedText = If(cC.Count = 0, InitialText, If(cC.Count > 1, sT.Substring(0, sT.Length - 6), cIt.Text))
            Else
                ...
                End If
            End If
            zzzlblCurrentSelectionText.Width = lblWidth(zzzlblCurrentSelectionText.Text)
        ...
        If SelectedValue <> vbNullString Then
            Dim sV() As String = SelectedValue.Split(",")
            For iL As Integer = 0 To sV.Length - 1
                ...
                For i As Integer = cPath.Count To 1 Step -1
                    ...
                    If n IsNot Nothing Then
                        ...
                        Else
                            If ShowCheckBoxes Then
                                n.Checked = True
                                If sV.Length > 1 Then SelectedText = "[בחירות מרובות]" Else SelectedText = n.Text
                            Else
                                n.Selected = True
    ...
    Public Property SelectedText() As String
        ...
        Set(ByVal Value As String)
            ...
            zzzlblCurrentSelectionText.Width = lblWidth(Value)
        End Set
    End Property
    ...
    Public ReadOnly Property TreeVisible() As Boolean
        Get
            _TreeVisible = Not zzzlblCurrentSelectionText.Visible
            Return _TreeVisible
        End Get
    End Property
    ...
    Public Overridable ReadOnly Property Items() As ListItemCollection
        ...
        End Get
    End Property
    Function lblWidth(s As String) As Integer
        Dim ilng As Integer = 0
        If s IsNot Nothing Then
            Dim sV() As String = s.Split("<br />")
            For i As Integer = 0 To sV.Length - 1
                ilng = If(ilng > sV(i).Length, ilng, sV(i).Length)
            Next
        End If
        Return ilng * 8
    End Function
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        zzzlblCurrentSelectionText.Text = InitialText
        If zzztvDropDown.Nodes.Count = 0 And TableName <> vbNullString Then zzztvDropDown.DataBind()
        zzzbtnshowtree.ID = "zzzbtnshowtree"
        If TableName = vbNullString Then
            zzztvDropDown.CollapseAll()
            Exit Sub
        End If
        If ShowCheckBoxes Then zzztvDropDown.ShowCheckBoxes = TreeNodeTypes.Leaf
