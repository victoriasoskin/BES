...
#Region "Form Setup"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("S") Is Nothing Then
            If Session("Repetative") = "1" Then Response.Redirect("SurveyForms.aspx") Else Response.Redirect("http://www.b-e.org.il")
        End If
        ...
        sUrl = Left(sUrl, InStrRev(sUrl, "/")) & "SurveyLogin.aspx?s=" & Request.QueryString("s")
        ...
        If Not IsPostBack Then
            ...
            SetSurveyCookies(SurveyID, sSurveyName, sShortDesc, dSartDate, dEndDate, 1, "Book10VPS")
...
#Region "Answers"
    ...
    Protected Sub tb_OnTextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If IsNumeric(hdnfrmid.Value) Then ConCompI.Parameters.AddWithValue("FrameID", hdnfrmid.Value)
        ConCompI.Parameters.AddWithValue("QuestionID", hdnid.Value)
        ConCompI.Parameters.AddWithValue("Txt", tb.Text)
        Dim df As New SqlParameter("ErrCODE", Data.SqlDbType.Int)
        df.Direction = Data.ParameterDirection.Output
        ConCompI.Parameters.Add(df)
        Try
...
#Region "Save Form"
    Protected Sub BTNCLS_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        cU.CommandText = "SELECT g.[Group],COUNT(a.QuestionID) AS c,COUNT(q.Must) AS m " & _
        ...
        If sE <> vbNullString Then
            ...
            Else
                ...
                scrMsg(sE, True, True, "שלח את השאלון למערכת", , "המשך במילוי השאלון", , "saveform", "lvqdatabind")
                Exit Sub
    ...
    Sub SaveForm()
        ...
        If b Then
            If Session("Repetative") = "1" Then
                Response.Redirect("SurveysSqlTemp.aspx?s=" & Request.QueryString("S"))
            Else
                Response.Redirect("SurveyThanks.aspx?s=" & Request.QueryString("S"))
            End If
...
#Region "Frames"
    ...
    Protected Sub cb_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If IsNumeric(hdn.Value) Then EFrame_q(hdn.Value, cb.Checked, hdnid.Value)
    End Sub
...
#Region "Form Navigation"
    ...
    Function PageSType(iSurveyID As Integer, iGrp As Integer) As String
        ...
        Return s
    End Function
    Function IsThisPage(sType As String) As Boolean ' Header="Feader",First = "First",Last="Last", Middle = Numeric 
        Dim s As String = vbNullString
        If TVGROUPS.SelectedNode Is Nothing Then
            s = "1"
        Else
