...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td style="width: 100px" valign="top">
                <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="Large" Text="טבלת סוגי אפוטרופסים"
    ...
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="CustApotroposTypeID" HeaderText="מס'"
                ReadOnly="True" SortExpression="CustApotroposTypeID" />
            <asp:BoundField DataField="CustApotroposTypeName" HeaderText="סוג אפוטרופוס"
        ...
        <AlternatingRowStyle BackColor="White" />
            ...
            <td style="width: 100px; height: 169px" valign="top">
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4"
                    ...
                    ForeColor="#37A5FF" GridLines="None" HeaderText="הוספת סוג אפוטרופוס" Height="50px"
                    Width="125px">
                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                    ...
                    <Fields>
                        ...
                        <asp:BoundField DataField="CustApotroposTypeName" HeaderText="סוג אפוטרופוס" SortExpression="CustApotroposTypeName">
                            <ItemStyle Wrap="False" />
                            <HeaderStyle Wrap="False" />
                        </asp:BoundField>
